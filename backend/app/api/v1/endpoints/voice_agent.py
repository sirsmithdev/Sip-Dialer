...
IMPORTANT: Route order matters in FastAPI! Static paths must be defined
BEFORE parameterized paths (e.g., /routes before /{agent_id}).
See ERR-005 in docs/ERROR_LOG.md
"""
...
# ============ Static Path Endpoints (MUST come before /{agent_id}) ============
